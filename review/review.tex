...
\begin{itemize}
	...
	\item they encrypt the client certificates with a password, we don't. but as they use the same key for all certificates security doesn't really increase
