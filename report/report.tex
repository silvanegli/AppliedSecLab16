...
\begin{footnotesize}
	\begin{prettytablex}{lXp{4cm}lll}
		No. & Threat &  Countermeasure(s) & L & I & Risk \\
		\hline
		1 & System Administrator: Intentionally or accidentally modify user data & Don't allow data access to administrators & {\it Low} & {\it Medium} & {\it Low} \\
		\hline
		2 & Script kiddies / Skilled hacker: Steal data & Always use encrypted communication, store data encrypted on backup, restrict access on user data & {\it Medium} & {\it Medium} & {\it Medium} \\
	\end{prettytablex}
\end{footnotesize}
...
\begin{footnotesize}
	\begin{prettytablex}{lXp{4cm}lll}
		No. & Threat &  Countermeasure(s) & L & I & Risk \\
		\hline
		1 & User: ? &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
		2 & System Administrator:   &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
		3 & Script kiddies: DDoS &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
		4 & Skilled hacker:   &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
		5 & Malware  &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
		6 & Organized Crime &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
		7 & Competitors  &  & {\it Low} & {\it High} & {\it Low} \\
		\hline
	\end{prettytablex}
\end{footnotesize}
